...
#import "processing.typ": photometrie-data, liver-weights-data
#import "../../lib/maths/regression.typ": linear-regression-iterative
#import "../../lib/maths/statistics.typ": correlation, wilcoxon-rank-sum-statistic, wilcoxon-signed-rank-statistic

#let relevant-data = (photometrie-data.find(
...
#let weight-data = relevant-data.find(it => it.sample_source == "Leber").with_rnase.measures.map(it => (it.concentration, liver-weights-data.at(it.initials).weight_g))
