...
#import "../../lib/metro-pkg/src/lib.typ": metro-setup, num
#metro-setup(
...
#let show-table-for-tests(tests) = table(
  ...
  [
    #show-test-result-significant(
      tests.both-eyes_glasses_vs_no-glasses_unpaired.test-result,
    )
  ],
  ...
  [
    #show-test-result-significant(
      tests.both-eyes_glasses_vs_no-glasses_paired.test-result,
    )
  ],
  ...
  [
    #show-test-result-significant(
      tests.best-single-eye_vs_both-eyes.test-result,
    )
  ],
  ...
  [
    #show-test-result-significant(
      tests.worst-single-eye_vs_both-eyes.test-result,
    )
  ],
