...
#let y = diff-smooth(histidin-data, order: 0, window: 10, degree: 2).map(
  it => it.at(1),
)
#let dy = diff-smooth(histidin-data, order: 1, window: 20, degree: 2).map(
  it => it.at(1),
)
#let d2y = diff-smooth(histidin-data, order: 2, window: 20, degree: 3).map((
  (x, y),
) => y)
#let d3y = diff-smooth(histidin-data, order: 3, window: 30, degree: 3).map(
  it => it.at(1),
)
